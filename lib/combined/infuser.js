...
if (typeof define === "function" && define.amd) {
    ...
    Version 0.2.0
*/
;(function(){var getInfuser = function($, trafficCop){
;var hashStorage = {
    templates: {},
...
infuserOptions = ['target','loadingTemplate','postRender','preRender','render','bindingInstruction','useLoadingTemplate','model','templateUrl','templateSuffix','templatePrefix',''];;var infuser = {
    storageOptions: {
        hash: hashStorage,
